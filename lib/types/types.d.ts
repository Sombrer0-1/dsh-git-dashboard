...
export type GitUnavailableCode = 'not-repository' | 'workspace-missing' | 'git-error' | 'timeout' | 'output-too-large';
...
export type GitFileStatus = 'added' | 'modified' | 'deleted' | 'renamed' | 'copied' | 'unmerged' | 'untracked';
...
export type GitFileDiffResult = GitFileDiffPreview | GitFileDiffTooLarge | GitFileDiffEmpty | GitFileDiffUnsupported | GitNotRepository | GitUnavailable;
